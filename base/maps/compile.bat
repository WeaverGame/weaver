...
"%xmap2%" -fs_basepath "%basepath%" -fs_game "base" -game "xreal" -light -v -fast -samples 2 -scale 1.5 -pointscale 1.5 -gamma 1.3 -bounce 8 -lightmapsize 1024 -compensate 4 -dirty "%1.map"
