...
cr_line         credits[] = {
	...
	{"                               Jani Reijonen (FI) - Graphics Artist, Concept Artist                  ", UI_CENTER | UI_SMALLFONT, colorRed},
	{"                                 'Endoperez' (FI) - Animator                                         ", UI_CENTER | UI_SMALLFONT, colorRed},
	{"", UI_CENTER | UI_SMALLFONT, colorWhite},

	{"Contributing Team:", UI_CENTER | UI_BIGFONT, colorBlack},
	...
	{"                                'Karvajalka' (FI) - 3D Props Artist                                  ", UI_CENTER | UI_SMALLFONT, colorRed},
	{"               Tuomas 'Bright Side' Kallinen (FI) - Audio Producer                                   ", UI_CENTER | UI_SMALLFONT, colorRed},
	{"                                        'leekenn' - Sound effects                                    ", UI_CENTER | UI_SMALLFONT, colorRed},
	{"                                'mikeplus64' (AU) - Environment Artist                               ", UI_CENTER | UI_SMALLFONT, colorBlack},
	{"                                       'eiM' (DE) - Programmer                                       ", UI_CENTER | UI_SMALLFONT, colorBlack},
	{"                                 'dutchmeat' (NL) - Programmer                                       ", UI_CENTER | UI_SMALLFONT, colorBlack},
	{"", UI_CENTER | UI_SMALLFONT, colorWhite},

	{"Other Contributers:", UI_CENTER | UI_BIGFONT, colorBlack},
