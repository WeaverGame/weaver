...
#define	GAME_VERSION		"Weaver-v001"	// Tr3B: always increase if you change the ET_, EV_, GT_ or WP_ types

// Tr3B: define this to use the new Quake4 like player model system
#define XPPM 1

#if defined(XPPM)
#define	DEFAULT_MODEL			"fallen"
#define	DEFAULT_HEADMODEL		"fallen"
#else
...
#define	CS_SWINFO				30	// stopwatch info
...
//	GT_KING_OF_THE_HILL			// TODO kill the king Unreal 1 style
	...
	GT_OBJECTIVE_SW,			// objective in stop watch mode
...
enum
{
	...
	PMF_SPRINT						= BIT(15),	// player is sprinting
...
typedef enum
{
	...
	STAT_STAMINA,				//WEAVER stamina (running, jumping, etc)
	STAT_POWER,					//WEAVER power for channeling
	STAT_MAX_POWER,				//WEAVER current maximum power (higher when ppl linked)
	STAT_THREADX,				//WEAVER current thread X displacement
	STAT_THREADY,				//WEAVER current thread Y displacement
	STAT_AIRPROTECT,
	STAT_FIREPROTECT,
	STAT_EARTHPROTECT,
	STAT_WATERPROTECT
...
enum
{
	...
	EF_AWARD_IMPRESSIVE		= BIT(18),	// draw an impressive sprite
	EF_AWARD_DEFEND			= BIT(18),	// draw a defend sprite
	EF_AWARD_ASSIST			= BIT(18),	// draw a assist sprite
	...
	EF_TAPOUT				= BIT(25),	// wounded player wants to respawn
	EF_WEAVEA				= BIT(14),	// WEAVER weaving status a
	EF_WEAVED				= BIT(15),	// WEAVER weaving status d
	EF_THREAD				= BIT(16),	// WEAVER weaving a thread
	EF_LINKED				= BIT(17)
};
// *INDENT-ON*
...
#define PW_FLIGHT PW_NONE
#define PW_SCOUT PW_NONE
#define PW_GUARD PW_NONE
#define PW_DOUBLER PW_NONE
#define PW_AMMOREGEN PW_NONE
#define PW_INVULNERABILITY PW_NONE
...
//#endif
	...
	EV_WEAVE_SHOT,
	EV_WEAVE_CASTCLEARED,
	EV_WEAVE_CLEAREDCHANGE,
	EV_WEAVE_ADDHELD,
	EV_WEAVEMISSILE_HIT,
	EV_WEAVEMISSILE_MISS,
...
typedef enum
{
	...
	MOD_A_AIR_BINDPLAYER,
	MOD_A_EARTH_QUAKE_S,
	MOD_A_EARTH_QUAKE_M,
	MOD_A_EARTH_QUAKE_L,
	MOD_A_FIRE_DARTS,
	MOD_A_FIRE_BALL,
	MOD_A_FIRE_MULTIDARTS,
	MOD_A_FIRE_BLOSSOMS,
	MOD_A_AIRFIRE_LIGHTNING,
	MOD_A_AIRWATER_DARTS_S,
	MOD_A_AIRWATER_DARTS_M,
	MOD_A_AIRWATER_RIP,
